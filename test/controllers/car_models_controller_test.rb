...
class CarModelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create car_model" do
    assert_difference("CarModel.count") do
      post car_models_url, params: { car_model: { manufacturer_id: @car_model.manufacturer_id, name: @car_model.name } }
    end
  ...
  test "should update car_model" do
    patch car_model_url(@car_model), params: { car_model: { manufacturer_id: @car_model.manufacturer_id, name: @car_model.name } }
